...
def parse_args():
    ...
    parser.add_argument('--data_path', type=str, default='/data_SSD1/fj/point_THUMOS14/dataset/THUMOS14')
    parser.add_argument('--model_path', type=str, default='./models/LACP_000')
    parser.add_argument('--output_path', type=str, default='./outputs/LACP_000')
    parser.add_argument('--log_path', type=str, default='./logs/LACP_000')
    ...
    parser.add_argument('--lr', type=str, default='[0.0001]*2100', help='learning rates for steps (list form)')
